...
RF24 radio(9, 10);                        // Set up nRF24L01 radio on SPI bus plus pins 8 & 9
...
//      }
   ...
   float rate = duration > 0 ? numBytes / duration : -1;
